...
<script>
    ...
    $('#uporders').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Yii::app()->createUrl('delivery/expense/todayOrder'); ?>",
    ...
    $('#upsubmitBtn').click(function(){
        var data = $("#upexpense-form").serialize();
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->createUrl('delivery/expense/update?id='.$expense_id); ?>",
                data: data
            });
                //window.close()
    ...
    $(document).on("click", '.types' ,function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Yii::app()->createUrl('delivery/expense/upLists'); ?>",
            data: "id="+thisId,
            success: function(data){
                $('#updata').html(data);
            }
