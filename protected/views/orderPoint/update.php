...
<div>
    <form class="col-sm-5">
        <div class="form-group">
            ...
            <input type="text" name="point[name]" value="<?=$model['name']?>" class="form-control" placeholder="Наименование">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Логин</label>
            <input type="text" name="point[login]" value="<?=$model['login']?>" class="form-control" placeholder="Логин">
        </div>
        <div class="form-group">
