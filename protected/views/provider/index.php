...
$this->menu=array(
	array('label'=>'Поставщики','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('provider-grid')\",5000);
");
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->provider_id."|".$data->name',              
                	'click' => 'function(){
