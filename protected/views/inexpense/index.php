...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('inexpense-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('inexpense-grid')\",5000);
");
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		array(
	        'name'=> 'inexpense_id',
	        'value' => '($data->inexpense_id)',
	        'headerHtmlOptions' => array('style' => 'text-align:center;'),
	    ),
		
		array(
	        'name'=> 'inexp_date',
	        'value' => '($data->inexp_date)',
	        'headerHtmlOptions' => array('style' => 'text-align:center;'),
	    ),
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->inexpense_id."|".$data->inexpense_id',              
                	'click' => 'function(){
