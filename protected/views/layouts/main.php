...
<head>
    ...
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/dataTables.jqueryui.css" rel="stylesheet">
    ...
    <div id="page">
        ...
        <nav class="navbar-default MainNavbar  navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    <?=CHtml::link('<i class="fa fa-list-alt fa-fw"></i> Внутренний расход',array('expense/kindCreate'));?>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user" id="yw1">
                        <li><?=CHtml::link('<i class="fa fa-plus-square"></i> Заявка на приход',array('faktura/request'));?></a></li><br>
