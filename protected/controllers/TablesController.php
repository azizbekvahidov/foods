...
class TablesController extends SetupController
{
    ...
    public function actionCreate()
    {
        ...
        if(isset($_POST['Tables']))
        {
            ...
            try{
                ...
                if($model->save()){
                    $this->logs('create','tables',$model->table_num,$model->name);
                    $messageType = 'success';
                    $message = "<strong>Поздравляю!</strong> Вы успешно добавили продукт ";

                    $transaction->commit();
                    Yii::app()->user->setFlash($messageType, $message);
                    $this->redirect(array('create','id'=>$model->table_num));
                }
            }
            catch (Exception $e){
    ...
    public function actionUpdate($id)
    {
        ...
        if(isset($_POST['Tables']))
        {
            ...
            try{
                ...
                if($model->save()){
                    $this->logs('update','tables',$model->table_num,$model->name);
                    $transaction->commit();
                    Yii::app()->user->setFlash($messageType, $message);
                    $this->redirect(array('view','id'=>$model->table_num));
                }
            }
            catch (Exception $e){
                $transaction->rollBack();
    ...
    public function actionDelete($id)
    {
        if(Yii::app()->request->isPostRequest)
        {
            ...
            $this->logs('delete','tables',$id,'delete');
