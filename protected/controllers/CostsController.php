...
class CostsController extends SetupController
{
	/**
	...
	public function actionCreate()
	{
		...
		{
            $_POST['Costs']['user_id'] = Yii::app()->user->getId();
            $_POST['Costs']['cost_date'] = date('Y-m-d H:i:s');
			$model->attributes=$_POST['Costs'];
			if($model->save())
				$this->redirect(array('site/index'));//view','id'=>$model->cost_id));
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Costs']))
		{
			$model->attributes=$_POST['Costs'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->cost_id));
		}
